	...
	public override void CreateCard()
	{
		...
		assets.Add(
			new CardDataBuilder(mod)
				...
				.WithText("<card=dstmod.wolfgang> now increase max <keyword=attack> to all allies instead but increase <card=dstmod.wolfgang> max <keyword=counter> by 3".Process())
				.SetStats(null, null, 0)
