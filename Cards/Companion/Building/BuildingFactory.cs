...
public class BuildingFactory : BuildingBase
{
	public override void CreateCard()
	{
		buildings.AddRange(
			...
			{
				Create("scienceMachine", "Science Machine", "ScienceMachine.png",
					SStack(("On Turn Reduce Counter For Allies", 1)), null,
					new []{(ResourceRequire.Rock, 1),(ResourceRequire.Wood, 1)}, new[]{0,0,5}),
				Create("crockPot", "Crock Pot", "CrockPot.png",
					null, new[]{("Can Cook",1)},
					new []{(ResourceRequire.Rock, 1),(ResourceRequire.Wood, 1)}, new[]{0,0,5}),
			}
		);
