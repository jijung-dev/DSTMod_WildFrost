...
public abstract class BuildingBase : DataBase
{
	...
	public class BuildingInstance
	{
		...
		public BuildingInstance(string name, string title, string spriteName, (string name, int amount)[] withEffects, (string name, int amount)[] withTraits, (ResourceRequire name, int amount)[] resourceRequired, int[] stats)
		{
			_name = name;
			_title = title;
	...
	public BuildingInstance Create(string name, string title, string spriteName, (string name, int amount)[] withEffects, (string name, int amount)[] withTraits, (ResourceRequire name, int amount)[] resourceRequired, int[] stats)
	{
