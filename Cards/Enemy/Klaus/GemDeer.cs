        ...
        assets.Add(
            new StatusEffectDataBuilder(mod)
                ...
                .SubscribeToAfterAllBuildEvent<StatusEffectApplyXWhenDestroyedUnNullable>(data =>
                {
                    ...
                    {
                        new Scriptable<TargetConstraintIsCardType>(r => r.allowedTypes = new CardType[] { TryGet<CardType>("Leader") }),
                    };
        ...
        assets.Add(
            new TraitDataBuilder(mod)
                ...
                .SubscribeToAfterAllBuildEvent<TraitData>(data =>
                {
                    ...
                    data.effects = new StatusEffectData[] { TryGet<StatusEffectData>("When Hit Apply Spice To Self") };
                })
        );
        assets.Add(
            new TraitDataBuilder(mod)
                ...
                .SubscribeToAfterAllBuildEvent<TraitData>(data =>
                {
                    ...
                    data.effects = new StatusEffectData[] { TryGet<StatusEffectData>("When Hit Apply Snow To Attacker") };
                })
        );
    }
}
