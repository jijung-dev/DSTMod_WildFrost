	...
	protected override void CreateStatusEffect()
	{
		assets.Add(
			new StatusEffectDataBuilder(mod)
				...
				.SubscribeToAfterAllBuildEvent<StatusEffectInstantRandom>(
					data =>
					data.effects = new StatusEffectData[] { TryGet<StatusEffectData>("Snow"), TryGet<StatusEffectData>("Shroom"), TryGet<StatusEffectData>("Overheat") }
				)
			);
	}
}
